                    ...
                    <div class="billing-address">
                        ...
                        <div class="row field-row">
                            <div class="col-xs-12">
                                ...
                                <?= $form->field($model, 'name')->textInput(['class' => 'le-input'])->label(false) ?>
                            </div>
                        </div>
                        <div class="row field-row">
                            <div class="col-xs-12">
                                <label><?php echo Yii::t('frontend', 'Фамилия') ?></label>
                                <?= $form->field($model, 'surname')->textInput(['class' => 'le-input'])->label(false) ?>
                            </div>
                        ...
                        <div class="row field-row">
                            <div class="col-xs-12">
                                ...
                                <?= $form->field($model, 'patronymic')->textInput(['class' => 'le-input'])->label(false) ?>
                            </div>
                        </div>
                        <div class="row field-row">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                ...
                                <?= $form->field($model, 'phone')->textInput(['class' => 'le-input'])->label(false) ?>
                            </div>
                        </div>
