...
use common\components\FooterBuilder;
...
<div class="wrapper">
    ...
    <nav class="top-bar animate-dropdown">
        <div class="container">
            <div class="col-xs-12 col-sm-6 no-margin">
                <ul>
                    <li><a href="<?php echo Url::toRoute(['/']) ?>"><?php echo Yii::t('frontend', 'Главная') ?></a></li>
                    <li><a href="<?php echo Url::toRoute(['/site/faq']) ?>"><?php echo Yii::t('frontend', 'FAQ') ?></a>
                    </li>
                    <li>
                        <a href="<?php echo Url::toRoute(['/site/contact']) ?>"><?php echo Yii::t('frontend', 'Контакты') ?></a>
                    </li>
                </ul>
            </div>
            <div class="col-xs-12 col-sm-6 no-margin">
                <ul class="right">
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown"
                           href="#"><?php
                            echo LanguageSwitch::widget();
                            ?>
                    </li>
                    <?php if (!Yii::$app->user->identity): ?>
                        <li>
                            <a href="<?php echo Url::toRoute(['/site/signup']) ?>"><?php echo Yii::t('frontend', 'Зарегистрироваться') ?></a>
                        </li>
                        <li>
                            <a href="<?php echo Url::toRoute(['/site/login']) ?>"><?php echo Yii::t('frontend', 'Авторизоваться') ?></a>
                        </li>
                    <?php else: ?>
                        <li>
                            <?php echo Html::a(' ' . Yii::t('frontend', 'Выход') . ' (' . Yii::$app->user->identity->username . ')', Url::to(['site/logout']), [
                                'class' => '',
                                'data' => [
                                    'method' => 'post',
                                ]]) ?>
        ...
        <div class="container no-padding">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 top-search-holder no-margin">
                ...
                <div class="search-area">
                    ...
                    <?php echo Html::beginForm(Url::to(['site/search']), 'post') ?>
                    <div class="control-group">
                        <?php echo Html::input('text', 'search', '', [
                            'class' => 'search-field',
                            'placeholder' => '' . Yii::t('frontend', 'Найдите товар') . ''
                        ]) ?>
            ...
            <div class="col-xs-12 col-sm-12 col-md-3 top-cart-row no-margin">
                <div class="top-cart-row-container">
                    <div class="wishlist-compare-holder">
                        <div class="wishlist ">
                            <?php $countWishlist = Wishlist::countWishlist() ?>
                            <a href="<?php echo Url::toRoute(['/wishlist/index']) ?>"><i
                                        class="fa fa-heart"></i> <span
                                        class="value">(<?php echo $countWishlist ?>)</span> </a>
                        </div>
                        <div class="compare">
                            <?php $countCompare = Compare::countCompare() ?>
                            <a href="<?php echo Url::toRoute(['/compare/index']) ?>"><i class="fa fa-exchange"></i>
                                <span
                                        class="value">(<?php echo $countCompare ?>)</span> </a>
                        </div>
                    </div>
                        ...
                        <div class="basket">
                            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                                ...
                                <div class="total-price-basket">
                                    <span class="lbl"><?php echo Yii::t('frontend', 'Корзина') ?>:</span>
                                    <span class="total-price">
                                        <?php
                                        if (count($productList) > 0) {
                                            foreach ($productList as $product) {
                                                if ($product->discount !== 0) {
                                                    $totalPrice += $productInCart[$product->id] * ($product->price - $product->price * $product->discount->value);
                                                } else {
                                                    $totalPrice += $productInCart[$product->id] * $product->price;
                                                }
                                            }
                                        }
                                        ?>
                                        <span class="sign">$</span><span
                                                class="value"><?php echo $totalPrice ?></span>
                                    </span>
                                </div>
                            </a>
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-4 col-sm-4 no-margin text-center">
                                                        <div class="thumb">
                                                            ...
                                                            <img alt=""
                                                                 src="<?php echo $product->getImage($image[0]) ?>"/>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-8 col-sm-8 no-margin">
                                                        <div class="title"><?php echo $product->header ?></div>
                                                        <div class="price">$<?php
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-6">
                                                    <a href="<?php echo Url::toRoute(['/cart/index']) ?>"
                                                       class="le-button inverse"><?php echo Yii::t('frontend', 'в корзину') ?></a>
                                                </div>
                                                <div class="col-xs-12 col-sm-6">
                                                    <a href="<?php echo Url::toRoute(['/cart/checkout']) ?>"
                                                       class="le-button"><?php echo Yii::t('frontend', 'Оформить заказ') ?></a>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                        ...
                                        <div class="basket-item">
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-12 no-margin">
                                                    <div class="title"><?php echo Yii::t('frontend', 'Ваша корзина пуста') ?></div>
                                                    <div class="price"><?php echo Yii::t('frontend', 'Добавляйте понравившиеся товары в корзину') ?></div>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
    ...
    <?php if (isset($this->params['flag'])): ?>
        <div class="animate-dropdown">
            <div id="top-mega-nav">
                <div class="container">
                    <?php if (isset($this->params['main'])): ?>
                        <div class="col-xs-12 col-sm-4 col-md-3 sidemenu-holder">
                            <!-- ================================== TOP NAVIGATION ================================== -->
                            <div class="side-menu animate-dropdown">
                                <div class="head"><i
                                            class="fa fa-list"></i><?php echo Yii::t('frontend', 'Все категории') ?>
                                </div>
                            ...
                            <?php if (isset($this->params['category'])): ?>
                                <li class="dropdown le-dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                        <i class="fa fa-list"></i> <?php echo $this->params['menu_title'] ?>
                                    </a>
                                    <ul class="dropdown-menu">
                                        <?php echo MenuWidget::widget(['id' => $this->params['menu']]) ?>
                                    </ul>
                                </li>
                            <?php elseif (isset($this->params['main_category'])): ?>
                                <?php echo MenuCategoryBuilder::show('menu_category_' . Yii::$app->language) ?>
                            <?php endif; ?>
                            <li class="breadcrumb-nav-holder">
                                <ul>
                                    <?php echo Breadcrumbs::widget([
                                        ...
                                        'activeItemTemplate' => "<li class=\"breadcrumb-item current\"><a href='#'>{link}</a></li>\n",
                                    ]);
                                    ?>
                                    <?= Alert::widget() ?>
                                </ul>
    ...
    <footer id="footer" class="color-bg">
            ...
            <div class="container no-padding">
                <div class="col-xs-12 col-md-4 ">
                    ...
                    <div class="contact-info">
                        ...
                        <p class="regular-bold"><?php echo Yii::t('frontend', 'Не стесняйтесь связаться с нами по телефону, электронной почте или просто отправьте нам письмо.') ?></p>

                        <p>
                            <?php echo Yii::t('frontend', '17 Princess Road, Лондон, Большой Лондон NW1 8JR, Великобритания 1-888-8MEDIA (1-888-892-9953)') ?>
                        </p>

                        <div class="social-icons">
                            <h3><?php echo Yii::t('frontend', 'Связаться') ?></h3>
                            <ul>
                ...
                <?php echo FooterBuilder::show('footer_menu_' . Yii::$app->language, [
                    'div' => 'col-xs-12 col-md-8 no-margin',
                    'div_div' => 'link-widget',
                    'div_div_div' => 'widget',
                ]) ?>
            </div><!-- /.container -->
        ...
        <div class="copyright-bar">
            <div class="container">
                <div class="col-xs-12 col-sm-6 no-margin">
                    <div class="copyright">
                        &copy; <a href="<?php echo Url::toRoute(['/']) ?>">Media Center</a>
                        - <?php echo Yii::t('frontend', 'Все права защищены') ?>
                    </div><!-- /.copyright -->
                </div>
                <div class="col-xs-12 col-sm-6 no-margin">
