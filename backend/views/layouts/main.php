                        ...
                        <ul class="dropdown-menu animation-expand">
                            ...
                            <li>
                                <a class="alert alert-callout alert-warning" href="javascript:void(0);">
                                    <img class="pull-right img-circle dropdown-avatar"
                                         src="/backend/web/img/avatar2.jpg?1404026449" alt=""/>
                            ...
                            <li>
                                <a class="alert alert-callout alert-info" href="javascript:void(0);">
                                    <img class="pull-right img-circle dropdown-avatar"
                                         src="/backend/web/img/avatar3.jpg?1404026799" alt=""/>
            ...
            <div class="menubar-scroll-panel">
                ...
                <ul id="main-menu" class="gui-controls">
                    ...
                    <li class="gui-folder">
                        ...
                        <!--start submenu -->
                        <ul>
                            <li><a href="<?php echo Url::to(['/language/index']) ?>"><span class="title">Language</span></a>
                            </li>
                            <li><a href="<?php echo Url::to(['/main-category/index']) ?>"><span
                                            class="title">Main Category</span></a></li>
                            <li><a href="<?php echo Url::to(['/category/index']) ?>"><span class="title">Category</span></a>
                            </li>
                            <li><a href="<?php echo Url::to(['/product/index']) ?>"><span
                                            class="title">Product</span></a>
                            </li>
                            <li><a href="<?php echo Url::to(['/redirect/index']) ?>"><span class="title">Redirect</span></a>
                            </li>
                            <li><a href="<?php echo Url::to(['/menu/index']) ?>"><span class="title">Menu</span></a>
                            </li>
                            <li><a href="<?php echo Url::to(['/users/index']) ?>"><span class="title">Users</span></a>
                            </li>
                        </ul><!--end /submenu -->
                    </li><!--end /menu-li -->
                    ...
                    <li class="gui-folder">
                        ...
                        <ul>
                            ...
                            <li class="gui-folder">
                                ...
                                <!--start submenu -->
                                <ul>
                                    <li><a href="../../html/ui/icons/materialicons.html"><span class="title">Material Design Icons</span></a>
                                    </li>
                                    <li><a href="../../html/ui/icons/fontawesome.html"><span
                                                    class="title">Font Awesome</span></a></li>
                                    <li><a href="../../html/ui/icons/glyphicons.html"><span
                                                    class="title">Glyphicons</span></a>
                                    </li>
                                    <li><a href="../../html/ui/icons/skycons.html"><span
                                                    class="title">Skycons</span></a>
                                    </li>
                                </ul><!--end /submenu -->
                            </li><!--end /menu-li -->
                        </ul><!--end /submenu -->
                    ...
                    <li class="gui-folder">
                        ...
                        <!--start submenu -->
                        <ul>
                            <li><a href="../../html/tables/static.html"><span class="title">Static Tables</span></a>
                            </li>
                            <li><a href="../../html/tables/dynamic.html"><span class="title">Dynamic Tables</span></a>
                            </li>
                            <li><a href="../../html/tables/responsive.html"><span class="title">Responsive Table</span></a>
                            </li>
                        </ul><!--end /submenu -->
                    </li><!--end /menu-li -->
                    <!-- END TABLES -->
                    ...
                    <li class="gui-folder">
                        ...
                        <ul>
                            ...
                            <li><a href="../../html/forms/advanced.html"><span class="title">Form advanced</span></a>
                            </li>
                            ...
                            <li><a href="../../html/forms/validation.html"><span
                                            class="title">Form validation</span></a>
                            </li>
                    ...
                    <li class="gui-folder">
                        ...
                        <ul>
                            <li class="gui-folder">
                                ...
                                <!--start submenu -->
                                <ul>
                                    <li><a href="../../html/pages/contacts/search.html"><span
                                                    class="title">Search</span></a></li>
                                    <li><a href="../../html/pages/contacts/details.html"><span
                                                    class="title">Contact card</span></a></li>
                                    <li><a href="../../html/pages/contacts/add.html"><span
                                                    class="title">Insert contact</span></a></li>
                                </ul><!--end /submenu -->
                            </li><!--end /menu-li -->
                            <li class="gui-folder">
                                <a href="javascript:void(0);">
                                ...
                                <!--start submenu -->
                                <ul>
                                    <li><a href="../../html/pages/search/results-text.html"><span class="title">Results - Text</span></a>
                                    </li>
                                    <li><a href="../../html/pages/search/results-text-image.html"><span class="title">Results - Text and Image</span></a>
                                    </li>
                                </ul><!--end /submenu -->
                            </li><!--end /menu-li -->
                            <li class="gui-folder">
                                ...
                                <!--start submenu -->
                                <ul>
                                    <li><a href="../../html/pages/blog/masonry.html"><span
                                                    class="title">Blog masonry</span></a>
                                    </li>
                                    <li><a href="../../html/pages/blog/list.html"><span
                                                    class="title">Blog list</span></a>
                                    </li>
                                    <li><a href="../../html/pages/blog/post.html"><span
                                                    class="title">Blog post</span></a>
                                    </li>
                                </ul><!--end /submenu -->
                            </li><!--end /menu-li -->
                            <li class="gui-folder">
                            ...
                            <li><a href="../../html/pages/profile.html"><span class="title">User profile<span
                                                class="badge style-accent">42</span></span></a></li>
                ...
                <div class="offcanvas-body">
                    <ul class="list-chats">
                        <li>
                            <div class="chat">
                                <div class="chat-avatar"><img class="img-circle"
                                                              src="/backend/web/img/avatar1.jpg?1403934956" alt=""/></div>
                                <div class="chat-body">
                        ...
                        <li class="chat-left">
                            <div class="chat">
                                <div class="chat-avatar"><img class="img-circle"
                                                              src="/backend/web/img/avatar9.jpg?1404026744" alt=""/></div>
                                <div class="chat-body">
